...
from trade_baby_trade.models.enums import GateStage, StrategyState, VenueAdapter
...
class ReferenceZeroDteStrategy(BaseZeroDteStrategy):
    ...
    def _subscribe_market_data(self) -> None:
        ...
        if self._ref_config.option_series_expiry is None:
            return
        from trade_baby_trade.strategies.selectors.deribit import deribit_option_series_id
    ...
    def _context_from_selection(
        ...
        from trade_baby_trade.strategies.selectors.deribit import _strike_price
